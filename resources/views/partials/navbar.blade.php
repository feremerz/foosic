<div class="w3-top">
    <div class="w3-bar w3-theme-d2 w3-right-align w3-large ">
        ...
        <a href="#" class="w3-bar-item w3-button w3-padding-large w3-theme-d4 w3-right"><i class="fa fa-music w3-margin-right"></i> فوسیک</a>
        ...
        <a href="#" class="w3-bar-item w3-button w3-hide-small w3-left w3-padding-large w3-hover-white" title="My Account">
            <img src="{{asset('assets/images/avatar2.png')}}" class="w3-circle" style="height:23px;width:23px" alt="Avatar">
        </a>
        <div class="w3-left top-search">
            <form action="">
                <input class="search-box" type="search">
                <i class="search-fa fa fa-search"></i>
            </form>
        </div>
    </div>
</div>
